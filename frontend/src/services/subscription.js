...
export const PLANS = {
  free: {
    ...
    target: 'Pengguna personal',
    role: 'personal',
    price: 0,
    monthly_price: 0,
    yearly_price: 0,
    features: [
      'Hingga 30 item inventaris',
      '5 pemindaian AI per bulan',
      'Pengingat kedaluwarsa dasar',
      'Rekomendasi dasar',
  ...
  personal_plus: {
    ...
    target: 'Pengguna rumah tangga lanjutan',
    role: 'personal',
    price: 29000,
    monthly_price: 29000,
    yearly_price: 278400,
    features: [
      'Inventaris tanpa batas',
      '100 pemindaian AI per bulan',
      'Rekomendasi resep cerdas',
      'Analitik limbah makanan',
      'Pengingat prioritas',
      'Jual di marketplace',
      'Pelacakan donasi',
      'Ekspor laporan personal',
    ],
    limits: {
  ...
  business_pro: {
    ...
    target: 'Restoran, hotel, kafe, katering, bakery, grocery',
    role: 'business',
    price: 149000,
    monthly_price: 149000,
    yearly_price: 1430400,
    features: [
      'Inventaris multi-cabang',
      'Pemindaian AI tanpa batas',
      'Manajemen stok massal',
      'Prakiraan risiko limbah AI',
      'Marketplace surplus',
      'Penjadwalan donasi',
      'Pesanan/reservasi',
      'Analitik bisnis',
      'Laporan keberlanjutan',
      'Akses tim siap pakai',
    ],
    limits: {
      max_inventory_items: UNLIMITED,
